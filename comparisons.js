...
// YOU DO: Explain.
// With this line of code you are asking if the number of friends (6) is greater than the number of siblings (2) using the preestablished variables that it gives and it would say true.
var attendees = 9;
var meals = 8;
console.log(attendees !== meals);
// YOU DO: Explain.
// This line of code will write if the number meals(8) is not equal to the number of attendees (9) and it would come back true
